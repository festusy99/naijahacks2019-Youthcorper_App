...
<body id="page-top">
  ...
  <nav class="navbar navbar-expand-lg bg-secondary text-uppercase fixed-top" id="mainNav">
    <div class="container">
      <a class="navbar-brand js-scroll-trigger" href="#page-top">Corpers</a>
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          <li class="nav-item mx-0 mx-lg-1">
            <a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="#apartments">Apartments</a>
          </li>
          <li class="nav-item mx-0 mx-lg-1">
              <a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="#">Corpers' Trade</a>
            </li>
          <li class="nav-item mx-0 mx-lg-1">
          ...
          <li class="nav-item mx-0 mx-lg-1">
            ...
            <a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="{{ url('/home') }}">Home</a>
              ...
              @else
          <li class="nav-item mx-0 mx-lg-1">
            <a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="{{ route('login') }}">Sign In</a>
          </li>
  ...
  <header class="masthead bg-primary text-white text-center">
    <div class="container d-flex align-items-center flex-column">
      ...
      <!-- Masthead Heading -->
      <h1 class="masthead-heading text-uppercase mb-0">Welcome to Corpers Apartments</h1>
      ...
      <!-- Masthead Subheading -->
      <p class="masthead-subheading font-weight-light mb-0">Corpers - Connect - Apartments</p>

    </div>
  </header>

  <!-- Apartment Section -->
  <section class="page-section portfolio" id="apartments">
    <div class="container">

      <!-- Apartment Section Heading -->
      <h2 class="page-section-heading text-center text-uppercase text-secondary mb-0">Available Apartments</h2>
...
<div class="portfolio-modal modal fade" id="lodge" tabindex="-1" role="dialog" aria-labelledby="portfolioModal1Label" aria-hidden="true">
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-lg-4 ml-auto">
          <p class="lead">Corpers' apartments is an initiative of w4tchnl3rn Team in the 2019 Naija Hacks program</p>
        </div>
        <div class="col-lg-4 mr-auto">
          <p class="lead">Corpers's Apartments is meant to bring apartments suitable for corpers who have been posted to alien places. It will also make it more affordable as houses here will be quit competitive!</p>
        </div>
      </div>
      ...
      <div class="text-center mt-4">
        <a class="btn btn-xl btn-outline-light" href="#contact">
          Welcome - Will you like to keep in touch?
        </a>
      </div>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-4 mb-5 mb-lg-0">
          ...
          <p class="lead mb-0">Zone Tech Park
            <br>Plot 9 Gbagada Industrial Scheme, Beside UPS, Gbagada Expressway, Lagos State</p>
        </div>
        ...
        <!-- Footer About Text -->
        <div class="col-lg-4">
          <h4 class="text-uppercase mb-4">About Corpers Apartments</h4>
          <p class="lead mb-0">Corpers Apartments is an initiative to ease the life of corpers in Nigeria</a>.</p>
        </div>
  ...
  <section class="copyright py-4 text-center text-white">
    <div class="container">
      <small>Copyright &copy; Corpers 2019</small>
    </div>
  </section>
